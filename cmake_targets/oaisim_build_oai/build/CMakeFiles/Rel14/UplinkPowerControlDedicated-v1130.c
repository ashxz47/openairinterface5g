...
static asn_TYPE_tag2member_t asn_MAP_UplinkPowerControlDedicated_v1130_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pSRS-Offset-v1130 at 6073 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pSRS-OffsetAp-v1130 at 6074 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* deltaTxD-OffsetListPUCCH-v1130 at 6075 */
};
