...
static asn_TYPE_member_t asn_MBR_SystemInformationBlockType1_v14xy_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType1_v14xy_IEs, eCallOverIMS_Support_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static int asn_MAP_SystemInformationBlockType1_v14xy_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_SystemInformationBlockType1_v14xy_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType1_v14xy_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eCallOverIMS-Support-r14 at 1902 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension at 1903 */
};
static asn_SEQUENCE_specifics_t asn_SPC_SystemInformationBlockType1_v14xy_IEs_specs_1 = {
