...
asn_comp_rval_t * 
ReestablishmentCause_NB_r13_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	ReestablishmentCause_NB_r13_1_inherit_TYPE_descriptor(td1);
	ReestablishmentCause_NB_r13_1_inherit_TYPE_descriptor(td2);
...
asn_TYPE_descriptor_t asn_DEF_ReestablishmentCause_NB_r13 = {
	...
	ReestablishmentCause_NB_r13_compare,
