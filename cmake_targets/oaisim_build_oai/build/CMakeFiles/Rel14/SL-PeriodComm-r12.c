...
asn_comp_rval_t * 
SL_PeriodComm_r12_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	SL_PeriodComm_r12_1_inherit_TYPE_descriptor(td1);
	SL_PeriodComm_r12_1_inherit_TYPE_descriptor(td2);
