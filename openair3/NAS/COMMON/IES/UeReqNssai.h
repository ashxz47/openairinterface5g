...
#ifndef UE_REQ_NSSAI_H_
#define UE_REQ_NSSAI_H_

#define UE_REQ_NSSAI_MINIMUM_LENGTH 1
#define UE_REQ_NSSAI_MAXIMUM_LENGTH 7

typedef struct UeReqNssai_tag {
