...
static asn_TYPE_tag2member_t asn_MAP_HandoverFromEUTRAPreparationRequest_v1020_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dualRxTxRedirectIndicator-r10 at 331 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* redirectCarrierCDMA2000-1XRTT-r10 at 332 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonCriticalExtension at 333 */
};
