...
BandParametersDL_r13_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	...
	td->compare        = asn_DEF_CA_MIMO_ParametersDL_r13.compare;
...
asn_comp_rval_t * 
BandParametersDL_r13_compare(asn_TYPE_descriptor_t *td1,
		const void *structure1,
		asn_TYPE_descriptor_t *td2,
		const void *structure2) {
	asn_comp_rval_t * res  = NULL;
	BandParametersDL_r13_1_inherit_TYPE_descriptor(td1);
	BandParametersDL_r13_1_inherit_TYPE_descriptor(td2);
