...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_3 = {
	sizeof(struct SCG_ConfigInfo_v1330_IEs__nonCriticalExtension),
	offsetof(struct SCG_ConfigInfo_v1330_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_tag2member_t asn_MAP_SCG_ConfigInfo_v1330_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measResultListRSSI-SCG-r13 at 11619 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension at 11620 */
};
